...
## Identité
- **Type** : **Ville-état impériale** + **capitale du Middenland** (Grand Duché). **Cité construite sur un piton rocheux monolithique, le Fauschlag**, accessible uniquement par **viaducs** (Sud, Est, Nord) et **téléphérique** (Ouest). Surnommée **« la Cité du Loup Blanc »** (City of the Loup Blanc) — bastion d'Ulric.
- **Région** : **Middenland** (Empire du Nord). ~400 milles d'Altdorf (canon ch.1 *Altdorf-Middenheim Stages* : 6 jours en diligence). Le Graf gouverne directement un rayon de 30 milles autour de la cité, et **administre aussi le Nordland** (canon : *Wardenship of the Barony of Nordland*).
- **Population** : ~14 000 résidents permanents ; **+5 000 visiteurs pendant le Carnaval** (canon ch.5). Communauté **naine importante** (Engineers' Guild = 300 membres, la plus grande de l'Empire — la plus contestée par la Dwarf Tax Arc 5).
- **Souverain** : **[[Boris Todbringer|Graf Boris Todbringer]]**, Grand Duc de Middenland, **Imperial Elector**, prétendant historique au trône impérial (rival idéologique de Karl-Franz).
...
### Districts (par classe sociale, du haut vers le bas)
*(canon PBT ch.2 p.34-36 + map au début du livre)*

- **Palast (Palast District)** — Quartier le plus huppé. **Middenpalaz** (palais ducal de Boris). Résidences des advisors. **Square of Martials** (les Midden Marshals y vivent — Schutzmann, Schwermutt, von Genscher). Patrouilles **constantes** : les PJ sans tenue noble attirent l'attention.
- **Grafsmund + Nordgarten** — Quartiers nobles upper-class. Demeures des Law Lords **[[Reiner Ehrlich]] et [[Karl-Heinz Wasmeier]]** (le 3e, **[[Joachim Hoflich]]**, vit au palais). **Maison de Wasmeier = climax S39**. La Watch y est très active mais courtoise.
- **Ulricsmund** — Upper-middle-class. Maisons confortables, plus petites que Grafsmund. **Janna Eberhauer** y vit. **Temple d'Ulric** dans ce district (canon : « *the heart of the city's settlement, second only in size to the great Temple of Sigmar in Altdorf* »).
- **Altmarkt** — Marché aux denrées alimentaires. **Halfelins fréquents**. Inclut le sous-district du **Kleinmoot** (« the Halfling District »).
- **Altquartier** — **Sombre, dangereux**. Le Watch n'y va qu'en force. Lieu de **la Fosse** (canon : *The Pit*), repaire des bas-fonds, Bruno Kohl, etc. **La planque de Brunhilde Klaglich y est** (Arc 5 S37). Lieu de l'**embuscade S30** Main Pourpre. Activités illicites = part importante de l'économie locale.
- **Southgate** — Pauvre mais respectable. Habitants endurcis.
- **Ostwald** — **Aussi dangereux que l'Altquartier** mais les voleurs ne tuent généralement pas. **Lair de Brunhilde + complices** (canon ch.2 p.36). **Repaire trouvé S36 + raid S37**.
- **Neumarkt** — Marché général (sauf nourriture). « Si on ne le trouve pas ici, c'est illégal ».
- **Osttor** — Lower-middle-class. **Maison d'Allavandrel Fanmaris** (Master of the Hunt). Bohème, drinking establishments.
- **Nordtor** — Au nord d'Osttor. **Royal College of Music** historique. Décline mais respectable.
- **Freiburg** — Quartier universitaire. **Collegium Theologica** (la grande université de Middenheim). Académiciens, mages, prêtres, étudiants.
- **Wynd** — Quartier des artisans. Communauté forte.
- **Westor + Sudgarten** — Quartier résidentiel pieux. Trois temples : Verena, Shallya, Myrmidia.
- **Geldmund + Kaufseit + Brotkopfs** — Hub commercial. **Maison de Gotthard Wallenstein** dans le Geldmund (canon p.36 + ch.7 p.99 : « *one of the larger homes is owned by Gotthard Wallenstein* »). Marchands.
...
- **Templar's Arms (Les Armes du Templier)** — Auberge moyenne gamme (canon p.22). **Base PJ Arc 5**. Lieu de l'attaque skaven S34 (canon ch.6 p.89).
- **Square of Martials** — Place centrale du Palast. **Watch headquarters + résidences Midden Marshals**. Lieu des **Challenges to the Graf's Champion** (Carnaval).
- **Bernabau Stadium** — Stade. Minotaur Fights + Middenball (Snotball) + Snotling Football.
...
### Le Graf et sa famille
- **[[Boris Todbringer]]** — Imperial Elector, prétendant rival historique de Karl-Franz. **Veuf 2 fois** (Maria von Richthofen, mère légitime de Stefan ; Anika-Elise Nikse, morte « il y a quelques mois » = Purple Brain Pox MJ-only). **Dépressif Arc 5**, **se rétablit post-S39** (canon ch.7 *Consequences*). **Allié majeur Arc 6+**.
...
- **Kommissions** (organes administratifs) :
  - **Kommission pour le Commerce, le Métiers et les Impôts** (chair = Gotthard Wallenstein)
  - **Kommission pour les Intérêts des Elfes, des Nains et des Halfelins** (= EDH)
  - **Worshipful Guild of Legalists** (drafting des lois)
  - **Komission pour la Santé, l'Éducation et le Bien-être**
  - **Komission pour les Travaux Publics**

### Conseil des Vingt (Council of Twenty)
Organe politique de Middenheim. Les Marshals + Chancellor + Law Lords + autres dignitaires + représentants de guildes. **Boris détient en théorie l'autorité finale**, mais le Conseil débat des lois.

### Influence sur le Graf (canon ch.3 *The Evil Plot* p.40)
**17 « votes d'influence »** sur le Graf, répartis :
- Chancellor Sparsam : 2 votes
- Champion Schmiedehammer : 1 vote
- Court Minstrel Lafarel : 1 vote
- 'Princess' Katarina : 3 votes
- Chaperone Zimperlich : 1 vote
- The Military (3 Marshals) : 1 vote
- The Wizards (Helseher + Eberhauer) : 1 vote
- High Priest of Ulric (Jarrick Valgeir) : 1 vote
- Emmanuelle, Graf's Paramour : 2 votes
- Court Physician Pavarotti : 1 vote
- The Law Lords (3) : 3 votes
...
### Le Carnaval (Arc 5)
**Cycle de 4 ans** : Spring, Summer, Autumn, **Winter (privé)**. À table : **Winter Carnival 2512** (cycle privé). Foule + 5 000 visiteurs canoniquement, mais à table le hiver = visiteurs encore importants en raison du **Carnaval public**, à interpréter.

8 jours actifs : **Wellentag → Aubentag → Marktag → Backertag → Bezahltag → Konigstag → Angestag → Festag**. Le 9e jour = clôture sans événement.

Major events Arc 5 :
- **Challenges to the Graf's Champion** (Square of Martials, J1-4)
- **Festival of Fine Ales** (Great Park, J1-3)
- **Minotaur Fights** (Bernabau, J1-3)
- **Snotball / Middenball** (Bernabau, J4-7 — Final Angestag = Eastenders 3 vs Southgate 2)
- **Operas** (Royal College, J1-8)
- **Garden Party** (Royal Gardens, J3, 4-8pm) — événement social majeur, présent 16 PNJ majeurs
- **Archery Tournament** (Square of Martials, J1-3) — Allavandrel toujours vainqueur
- **Pageants & Jousting** (Great Park, J5-8)
- **Illuminations of the Black Pool** (Great Park, soirées J5-8, Grand Finale Festag minuit-2am)
...
- **Cult de Verena** — Plus petit. Discret.
- **Cult de Myrmidia** — Plus petit. Discret.
- **Chapel of Grungni** (Dwarven) — Cult traditionnel naine.
- **Halfling shrines** (Esmeralda) — Maisons individuelles, pas de temple officiel.
- **Grand Guild of Wizards** — Helseher + Eberhauer. Influents.
- **Dwarven Engineers' Guild** — 300 membres. Le plus grand de l'Empire. **Centre de la résistance Dwarf Tax Arc 5**.
- **Merchants' Guild** — Wallenstein chairman.
...
### Externes / présentes en transit
- **Grand Theogonist** + escorte Sigmar (en visite récente Arc 5).
- **Délégation Reikland** — fluctue.
- **Délégation Bretonnia/Estalia/Norse** — visiteurs Carnaval.
- **Witch Hunters Sigmar** (escorte Theogonist).
- **Templars of the Fiery Heart** (escorte Theogonist).

## Apparitions par session (Arc 5)

| Session | Lieu(x) principaux | Événement |
|---|---|---|
| S30 | Pont Fauschlag → portes Sud → Altquartier (embuscade) → Templar's Arms | Arrivée + embuscade Main Pourpre + installation |
| S31 | Kommissions + Guildes + temples + Tour de magie | Enquêtes pré-Carnaval sur la taxe |
| S32 | Square + Great Park + Royal College + Bernabau | Carnaval J1 Wellentag (Mark vs minotaure, Sparsam ivre) |
| S33 | Square + Bernabau + Royal College (Opera) + Templar's Arms | Carnaval J2 Aubentag (**Filianore Tzeentch**) |
| S34 | Square + Royal College + Royal Gardens (**Garden Party**) + Templar's Arms (**raid Snikkit**) | Carnaval J3 Marktag |
...
- **FIL-13** — *Gideon (Sheru-Tar Gee'taru) survivant* — fui sous forme d'oiseau S38, antagoniste central Arc 7.
- **FIL-25** — *Animosity Kastor and Friends* — cellule MP Altdorf intacte, continue à traquer.
- **FIL Wasmeier vivant** — fui dans la Drakwald, **réapparaît S61 mariage impérial**.
- **FIL Mécène anonyme = Nastassia** — agente Heinrich Todbringer, **non révélé aux PJ avant Arc 6/7**.
- **FIL Wallenstein/Wittgenstein libre** — planque démantelée, lui non capturé.
- **FIL Cellule MP non démantelée** — Kalzbad + Jarmund + Bhar à l'ombre, Schutzmann veut les démanteler Arc 6.
- **FIL Carte du Fort d'Airain dérobée S34** — transmise aux skavens (lien Arc 6, S54 Le Piquet).
...
- **Arc 6** : Centre des opérations skavens (Yellow Fang + Maliss). Schutzmann pilote l'enquête PBT-suite (cellule MP Middenheim démantelée, S40-S43). PJ basés à Middenheim toute la durée Arc 6.
- **Arc 7** : Boris Todbringer = **allié majeur du Reikland-équilibre** (S56+). Délégation Reikland + Sigmar arrive (S57). Mariage Katarina/Wolfgang annoncé. Boris **mort S63** (homebrew table) lors de l'attaque manoir Todbringer (par « Volkmar » = Gideon = Changeling, identité non démasquée).
- **Long terme** : Heinrich devient héritier de fait post-S63. Katarina survit.

## Voisinage / routes

- **Sud** : route principale vers **Altdorf** (~400 milles, 6 jours diligence). Étapes : Schoninghagen → Grubentreich → Malstedt → Sotturm → Delberz → Mittelweg → Bröckel → Kutenholz → Frederheim → Altdorf.
- **Sud-Est** : **Reikgarde** + Reikland direct par Drakwald.
- **Nord** : route vers **Nordland** (Wolfenburg), via Drakwald. Heinrich Todbringer y est Arc 5.
- **Est** : **Talabecland** (tensions canon : Ostland vs Talabecland montent).
- **Ouest** : **Carroburg** (capitale sud du Middenland).
- **Skagerland** + **Sjoktraken** (peuples Sea Kings) — au nord-est, lointain.
