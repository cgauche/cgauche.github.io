...
- **Painted boulder route turn-off** :
  ...
  - **Southern face** : **Comète à 2 queues Sigmar en jaune**.
- **Track short** depuis boulder vers sanctuaire.
...
### Arc 7 ch.3 S58
- **Arrivée Middenheim delegation** : 2 jours voyage (Boris + Heinrich + Katarina + Veiran + Ar-Ulric Emil Valgeir + 20 knights mixed Chevaliers Panthères + Loup Blanc + PJ + Pesold + Albert).
...
- **Post-S58** : Katarina accepts mariage → Reikguard mission.
