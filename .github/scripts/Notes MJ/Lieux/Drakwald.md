...
**Sous-titre** : Vaste forêt frontière du Middenland, route Altdorf-Middenheim  
...
- **Lieux notables dans la forêt** :
  ...
  - **Lonely Tower et Two Fingers** — ruines elfiques d'avant la Guerre de la Barbe, accessibles seulement par des trajets pénibles à travers le Drakwald sans piste `Middenheim ch.5 l.68`.
  - **Lornalim groves** — bosquets profonds que les Elfes interdisent au défrichage ; aucun bûcheron n'a encore violé cette interdiction `Middenheim ch.5 l.25`.
...
- **Beastmen** : la forêt est tristement célèbre comme lieu où les Beastmen se rassemblent et s'organisent — leur densité diminue autour du Fauschlag, seuls les Beastlords les plus belliqueux osant provoquer ouvertement les chevaliers de Middenheim `Middenheim ch.5 l.97`. Des bases de Beastmen dévoués à Nurgle ont été établies dans le Drakwald et seraient responsables des fléaux qui ravagent les récoltes autour du Fauschlag `Middenheim ch.5 l.33`.
- **Blackweb Forest Goblins** : warbands gobelines des forêts qui hantent le Drakwald autour de la Barony of Holzbek, vassales d'une plus grande tribu, les Gloomfangs `Middenheim ch.5 l.92`.
- **Bandits et mutants** : les diligences traversant le Drakwald sont harcelées par mutants et bandits ; les grandes compagnies de diligences embauchent davantage de gardes et les Roadwardens recrutent à Altdorf et alentour `PBT ch.1 l.252`.
- **Patrouilleurs** :
  - **Swords of Ulric** — régiment payé par le Temple d'Ulric, datant du règne de Mandred Ratslayer ; plutôt que de s'entraîner dans la cité, le régiment chasse Beastmen et Greenskins dans le Drakwald `Middenheim ch.4 l.648`.
  - **Chevaliers du Loup Blanc** et **Chevaliers Panthères** — recrutent constamment pour remplacer les chevaliers tombés en campagne contre les Greenskins et Beastmen du Drakwald `Middenheim ch.1 l.662`.
- **Bûcherons et exploitants forestiers** : Middenheim tire une grande part de sa richesse du bois récolté dans le Drakwald, transporté en grumes jusqu'aux scieries du quartier marchand, puis acheminé par l'Old Forest Road jusqu'à Dunfurt et de là sur la Taub `Middenheim ch.5 l.17`. Les Elfes Eonir sont consultés sur les pratiques de coupe, et le Drakwald est si vaste et régénérant que l'exploitation actuelle ne menace pas la forêt `Middenheim ch.5 l.19`.
- **Drakwald Mancatchers** : sous-espèce d'Araignées Géantes propres à la forêt ; les légendes parlent de spécimens grands comme des Dragons `Middenheim ch.4 l.223+859`.

## Rôle Arc Power Behind the Throne

- **Traversée Altdorf → Middenheim** `PBT ch.1 l.70` : les PJ doivent organiser leur voyage par la route, à travers le périlleux Drakwald — c'est la transition forcée entre le climax d'*Death on the Reik* et le hub middenheimer.
- **Le décret du mutant** `PBT ch.1 l.248` : rumeur impériale selon laquelle l'« infamous mutant decree » de l'Empereur tente d'éviter la guerre ouverte avec Middenheim — « *the Beastmen of the Drakwald were once as Human as Graf Boris himself* ».
- **Le repaire de Karl-Heinz Wasmeier** `PBT ch.7 l.614` : après sa fuite ch.7, Karl-Heinz Wasmeier se terre dans un *hidden Drakwald lair* — angle pour le retour ennemi Arc 6/Arc 7.
...
- **Voyage initial Altdorf → Middenheim** `PBT ch.1 l.70` : traversée du Drakwald décrite comme longue et périlleuse.
- **Refuge post-démasquage de Karl-Heinz Wasmeier** `PBT ch.7 l.614` : si Karl-Heinz Wasmeier survit ch.7, il se cache dans un repaire du Drakwald.

## Apparitions Arc 7

- **Trajet du dirigeable d'Heinrich Todbringer (ch.1)** `EiR ch.1 l.196+232` : survol Middenheim → Reikland coupé par les aigles géants puis par les fusées Helstorm.

## Liens externes

- [Drakwald Forest — Lexicanum](https://whfb.lexicanum.com/wiki/Drakwald_Forest)
- [Drakwald — Warhammer Fantasy Wiki](https://warhammerfantasy.fandom.com/wiki/Drakwald)
