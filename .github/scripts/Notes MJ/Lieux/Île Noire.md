...
- **Cercle Intérieur** : Graf Liepmund Holzkrug (Grand Ambassadeur, chef),
  Immanuel-Ferrand Holswig-Schliestein (Grand Chancelier),
  Yann Zuntermein (tête du Spionwerber, secrètement Magister Magistri Main Pourpre),
  Hermann von Feilbach (membre Reiksguard + Chambre Noire, sosie de Karl-Franz).
- **Top Spy/Diplomat** : Emmanuelle Nacht (agente d'Immanuel-Ferrand,
  redirigée vers Ubersreik).

## Hooks

- **Investigation MJ** : si les PJ creusent sur Zuntermein, l'Île Noire
  est un lieu naturel d'enquête — mais haute sécurité.
...
- **Lieu parent** : Altdorf.
- **Faction principale** : Chambre Noire.
- **PNJ basés** : Liepmund Holzkrug, Yann Zuntermein, Immanuel-Ferrand Holswig-Schliestein, Emil Baecker.
