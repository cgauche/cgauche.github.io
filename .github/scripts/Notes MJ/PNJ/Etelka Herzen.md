...
### [S24] — Mine d'Etelka près de Grissenwald
- **Récit table** : les PJ apprennent à Grissenwald (rixe de taverne, nain frappé) que les nains avaient autrefois la mine au sud, qu'**une femme la leur a rachetée** (les nains la disent **sorcière**) et que des attaques nocturnes désolent les fermes alentours.
- Investigation : les PJ se planquent une nuit dans la ferme la plus exposée. **Pas d'attaque sur place**, mais une autre ferme est massacrée à quelques centaines de mètres — traces **non-naine**.
...
- **Récit table** : voyage Grissenwald → Kemperbad (vente de vin, intermède théâtre forcée par une noble illuminée), puis vers Unterbaum. Elvira s'absente puis le groupe part **sans elle**.
- **Pathsokar** croise un homme en pourpre en ville qui lui demande **l'héritage** de Kastor (FIL-25 / animosity).
- Unterbaum : le prêtre **[[Corrobreth]]** (Rhya) guide les PJ aux Collines Stériles le lendemain matin (plusieurs heures de montée).
- **Zone aride, brumeuse, sans faune ni flore**. Lac dans un cratère + cairns. **Esprits éthérés** apparaissent près du lac, prennent peur en voyant les PJ et **fuient vers une grande roche flanquée d'un tunnel**.
- Les PJ entrent. Restes humains. Esprits tentent de communiquer. Surgissement d'**Etelka + Heidlemann + 2 gros gaillards** sortant d'un couloir, en plein combat contre **skavens + squelettes**.
- **Etelka attaque immédiatement** les PJ avec un **violent sort de foudre**. **Plusieurs PJ assommés**.
- **Esprits trahis aident les PJ**. Combat tourne en faveur du groupe. **Etelka + Heidlemann + 2 sbires tués** sur place.
- Les esprits, libérés, expliquent qu'ils avaient été tués jadis par **Dagmar** (le notable de l'expédition originelle) sur l'île au phare du Reik. Sépulture érigée par les PJ → esprits **apaisés** (FIL-52, résolu).
- **Indice livré** : la pierre céleste avait été ramenée à l'île au phare. Prochaine étape : l'île au phare (S26).

## Ce que les PJ savent
- Sorcière. Officiellement présentée par Filianore comme « liée à la Main Pourpre » — **information fausse** (Filianore ment, cf. MJ-only).
- Liée à **Ernst Heidlemann** (mage qui l'avait informée — mort à ses côtés S25).
- Possédait une **mine près de Grissenwald** rachetée à des nains et gardée par des gobelins. Mine démantelée par les PJ.
- **Morte par leurs mains S25**, aux Collines Stériles, dans le tunnel sous la grande roche.
- Les PJ disposent (Filianore) du **carnet d'Etelka** (FIL-50), seul document écrit la concernant.
