...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 4 | 30 | 32 | 30 | 26 | 31 | 34 | 44 | 33 | 30 | 29 | 10 |
...
**Trappings** : **Book** (couverture trompeuse : "Leeches and their Curative Properties" en fausse couverture sur **De Vitae Occultae Daemoniis** "The Secret Life of Daemons" en Classical), Travelling Case (compartiment caché contenant **6 fioles de liquides verts + poudres colorées** = **préparations magiques pour Doktor Schmidt** à l'Université).

**Corruption** : **6** ⚠️ (déjà corrompu)

> **Note tactique** : combattant nul mais **lance Rot et Shock** (Petty Magic). **Petite quantité de Corruption** = corrompu mais pas mutant visible. **Channelling Dhar** = magicien noir formé.
...
### Le livre De Vitae Occultae Daemoniis

- Si un PJ lit ce livre : **basic knowledge of Daemons** (cf. Bestiary WFRP) + **Minor Exposure to Corruption** (Challenging Cool ou +1 Corruption).
- À table : Phineas / Anselm n'ont **pas lu** le livre (Ernst est parti vite).

### Apparition S4
- Au Coach and Horses Inn : seul dans son coin avec son livre. Elvira tente de sympathiser, il se dérobe et part se coucher. **À table : le piège Blackie/démon Fhluger'dagh non-déclenché** (canon : si Blackie le corbeau récite le livre à voix haute, invocation d'un Lesser Daemon).

### Réapparition future Arc 4 (Death on the Reik)
