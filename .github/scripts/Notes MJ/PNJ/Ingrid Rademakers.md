...
> **Eagle Eye** des Neuf Yeux — tutrice **Natural history + Fencing** de Wolfgang. Originaire **Talabheim**. Cultiste Tzeentch active. **Sleeps lightly + violent defense** : si dérangée snatches **rapier** + **Beat Blade, Distract, Feint, Riposte talents** → **PJ risquent murder charge** si trop directs. **À NE PAS CONFONDRE** avec [[Ingrid von Wittgenstein]] (Arc 4) ni [[Ingrid Gausser]] (Nordland Arc 7 ch.1).

## Identité publique
- **Culte secret** : **Eagle Eye** (Neuf Yeux cell Tzeentch).
- **Spécialité** : Natural history + Fencing.
- **Ville d'origine** : Talabheim.
- **Apparence** : Elderly scholar grey robes — mais **fence-trained**.
...
### Arc 7 ch.4 S59
- **Castle Reikguard** : présente. Room avec **geological samples + animal bones + illuminated bestiaries + rack fine fencing weapons**.
- **Réaction défense** : **rapier snatch** + combat fencing avec talents.

### Arc 7 ch.13
- **Possible présence Volkshalle** climax — si vivante = +1 Power Sheerargetru.
...
## Liens
- **Arcs** : Arc 7 (S59 + ch.13).
- **PNJ liés** : autres 9 Yeux, [[Wolfgang Holswig-Abenauer]], [[Gideon]].
- **Lieux** : **Talabheim** (origine), **Castle Reikguard** (résidence).
- **Factions** : **Eagle Eye**, **Neuf Yeux**.
