...
[Luigi Pavarotti — Fandom](https://warhammerfantasy.fandom.com/wiki/Luigi_Pavarotti)

> **Médecin personnel de Stefan Todbringer** (baron handicapé). **Tilien**, recruté par [[Heinrich Todbringer]] à Miragliano. **Hédoniste flamboyant**, ivrogne, séducteur — mais **réellement compétent en hypnose** + médecine. **Allié potentiel** des PJ (peut débloquer l'hypnose de Dieter).

## Identité publique
- **Fonction** : **Médecin personnel** (Baronial Physician) du **Baron Stefan Todbringer**. Recruté par Heinrich Todbringer à Miragliano (Tilea).
- **Apparence** : Tilien, **larger than life en personnalité et appétits**. Réputation pour fréquenter les fleshpots + drinking halls de Middenheim. **Notorious**.
- **Personnalité** : **Bon vivant**, **hédoniste**, **séducteur**, **bouffon**. **Mais réellement compétent** : Stefan s'améliore sous ses soins. **Personality canon** : « *Larger than life in both personality and appetites... all agree that there is no real harm in him* ».
...
- **Carrière** : Physician + Apothecary.
- **Compétences fortes** : **Charm**, **Heal**, **Hypnotism**, **Lore (Medicine + Chemistry + Herbs)**, Consume Alcohol (très haut), Gossip.
- **Talents** : **Concoct**, Carouser, Read/Write, Hypnotism.

## Réactions

- **Avec les femmes** : **séducteur agressif** (a tenté avec Emmanuelle Schlagen, refusée canon).
- **Avec les drinking companions** : meilleur ami.
- **Influence sur le Graf** : **1 vote** (canon).

## Personnalité

**Public** : Bouffon ivre + scandaleux + séducteur. **Rumeur courante** : Stefan s'améliore vraiment sous lui = **« may be a quack »** soupçonné par certains (Dieter par exemple).

**Réel** : **Médecin compétent + hypnotiseur talentueux**. Pas mal intentionné. Hédoniste authentique mais **sait sa profession**.
...
- **[S40+]** — Continue à soigner Stefan. **Peut débloquer l'hypnose de Dieter** si demandé (canon Appendix III).
- **Arc 6-7** — Reste à Middenheim, **canon EiR** : *« provided he has not too thoroughly disgraced himself, remains a valued courtier in the eyes of most of Middenheim's high society »* (canon ch.7 *Consequences* p.105).

## Ce que les PJ savent

- Médecin de Stefan, tilien, hédoniste.
- Recruté par Heinrich.
- **Hypnotiseur compétent** (potentiel pour débloquer Dieter).
- Sauve Boris S38.
...
- **Arcs** : [[Arc 5 - Power Behind the Throne]] (S34+ secondaire, S38 sauvegarde Boris), Arc 6 (allié potentiel).
- **PNJ-clé** : [[Stefan Todbringer]] (patient principal), [[Heinrich Todbringer]] (a recruté Pavarotti à Miragliano), [[Boris Todbringer]] (sauveur médical S38), [[Dieter Schmiedehammer]] (peut le débloquer hypnose), [[Emmanuelle Schlagen]] (tentative séduction refusée), [[Josef Sparsam]] (Sparsam le craint à tort).
- **Lieux** : [[Middenheim]] (Middenpalaz Inner + fleshpots Altquartier/Geldmund).
- **Factions** : Court de Middenheim (médecin), aucune religieuse.
