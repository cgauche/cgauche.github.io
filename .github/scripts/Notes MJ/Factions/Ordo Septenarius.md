...
## Symbolisme
- **Sigil** : **7-pointed star** (heptagram) avec **beast's head** au centre. Inscrit "Ordo Septenarius".
- **Couleur rituélique** : robes **rouges** avec sigil sur la poitrine. **Coiffes pointues** cachant complètement le visage.
- **Outils rituels** : cercle de copper 15 ft, 8 candélabres argent + black candles, sacrificial knife (Manifest Lesser Daemon scroll). Octogramme à la peinture bleue-foncée ou sel.

## Structure & membres

### Hiérarchie
- **Chef** : [[Johannes Teugen]] [MORT S12]
- **"Cousin" et conseiller** : "Gideon" = [[Gideon]] (démon Tzeentch, vraie nature inconnue des autres) [DISPARU]
- **Inner Council de 7** :
  - [[Franz Steinhäger]] [DISPARU S12]
  - [[Friedrich Magirius]] [MORT S12 — tué par Gideon]
  - **5 autres canoniquement non-nommés** (à inventer si besoin)
  - **Remplaçant à S12** pour Magirius = "drafted in from the lower echelons" (canon ch.9 l.170)
- **49 membres rank-and-file** (42 + 7) — la plupart **ignorent l'enjeu réel**, croient l'Ordo être un cercle exclusif d'aide aux marchands + ritualisme symbolique pour souder le groupe.

### Membres "Inner" et leurs rôles canon
- **Teugen** : daemonologist, croit échapper à son pacte 7 ans en sacrifiant 7 mortels à la place.
...
- **[S9]** — Foire Schaffenfest (Inner Council est en ville, prépare le rituel). **Mystic Megret prophétise "7 et 2 qui détruiront"**.
- **[S10]** — PJ découvrent Hidden Temple sous bureaux Steinhäger. Tuent Guardian Daemon. Trouvent mouchoir "F.S." (faux indice).
- **[S11]** — Identification publique de l'Ordo. Magirius confronté, change de ton. Reunion Inner Council villa Teugen le soir.
- **[S12]** — **Échec du rituel** au Warehouse 13. Teugen mort, Gideon disparait, Inner Council fuit en panique.

## Ce que les PJ savent
- **Ordo Septenarius** = culte Tzeentch décapité à Bögenhafen.
- Inner Council = 7 marchands + Teugen + Gideon.
- Teugen mort, Magirius mort, Steinhäger en fuite.
- "L'enfant sinistre" était la forme d'un démon (Gideon, identité non révélée).
...
## Liens
- **Arcs** : [[Arc 2 - Bögenhafen]] (centre), `Arc 7` (continuité via Sheerargetru/Haagen)
- **Fils ouverts** : FIL-15 (Haagen+BFP), FIL-20 (Steinhäger survivant), FIL-27 (Inner Council survivants)
- **PNJ-clé** : [[Johannes Teugen]] (chef), [[Gideon]] (vrai pouvoir), [[Franz Steinhäger]] (Inner), [[Friedrich Magirius]] (Inner, mort)
- **Lieux** : [[Bögenhafen]] (base), Schmerzeit Mine BFP (extension), [[Nuln]] (origine Teugen)
- **Maître** : **Sheerargetru** (Greater Daemon Tzeentch, BFP)

## Liens externes
- [Ordo Septenarius — Lexicanum (allemand)](https://whfb-de.lexicanum.com/wiki/Ordo_Septenarius) *(pas de page EN dédiée — détails complets dans Shadows Over Bögenhafen)*
